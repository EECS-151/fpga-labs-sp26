...
module fifo_tb();
  ...
  // logic filled with test vectors for the testbench
  logic [WIDTH-1:0] test_values[50-1:0];
  // logic used to collect the data read from the FIFO
  logic [WIDTH-1:0] received_values[50-1:0];
