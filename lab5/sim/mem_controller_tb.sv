...
module mem_controller_tb();
    ...
    logic mem_rx_rd_en;
    logic mem_tx_wr_en;
    logic [FIFO_WIDTH-1:0] rx_dout;
    logic [FIFO_WIDTH-1:0] tx_din;
    logic [5:0] LEDS;
    ...
    logic tb_tx_empty;
    logic [FIFO_WIDTH-1:0] tb_tx_dout;
    logic tb_tx_rd_en = 0;
    ...
    logic [23:0] test_write [NUM_WRITES-1 : 0];
    /* READ (8'd48, 8'd<addr>) in first to last byte order */
    logic [15:0] test_read [NUM_READS-1 : 0];
    logic [7:0] test_read_vals [NUM_READS-1: 0];
    ...
    logic [7:0] verify_addr;
    logic [7:0] verify_data;
